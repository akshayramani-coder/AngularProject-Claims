...
@Component({
  selector: 'app-track-claim-list',
  templateUrl: './track-claim-list.component.html',
  styleUrls: ['./track-claim-list.component.scss']
})
export class TrackClaimListComponent implements OnInit {
